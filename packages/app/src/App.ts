...
export default class App {
  ...
  getAwsEstimatesFromInputData(
    ...
    const config = configLoader()
    const AWS = config.AWS
    console.log("Inside get AWS Estimates From Input Data function.");
    //console.log("Before assigning properties of AWS account.");
    //console.log("credentials: ");
    //console.log("Billing Account id: "+AWS.BILLING_ACCOUNT_ID+ " Account name: "+AWS.BILLING_ACCOUNT_NAME+" Region: "+AWS.ATHENA_REGION);
    var a = new AWSAccount(AWS.BILLING_ACCOUNT_ID, AWS.BILLING_ACCOUNT_NAME, [
      AWS.ATHENA_REGION,
    ]);
    //console.log("Asigned");
    return a.getCostAndUsageReportsDataFromInputData(inputData)
  }
